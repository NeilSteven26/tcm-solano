    ...
    <>
      ...
      <div className="overflow-x-hidden text-neutral-300 antialiased selection:bg-cyan-300 selection:text-cyan-900">
        <div className="fixed top-0 -z-10 h-full w-full">
          <div className="absolute top-0 z-[-2] h-screen w-screen bg-gradient-to-r from-blue-500 to-red-500 bg-[radial-gradient(ellipse_80%_80%_at_50%_-20%,rgba(10,119,198,0.3), rgba(255,255,255,0))] "></div>
        </div>
